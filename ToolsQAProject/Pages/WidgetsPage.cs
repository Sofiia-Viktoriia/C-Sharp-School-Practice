...
{
    internal class WidgetsPage : CategoryPage
    {
        private IWebElement AutoCompleteMultipleValuesInput => WebDriver.FindElement(By.XPath("//div[@id='autoCompleteContainer']//div[@id='autoCompleteMultiple']//input"));
        private ReadOnlyCollection<IWebElement> AutoCompleteSuggestions => WebDriver.FindElements(By.XPath("//div[@id='autoCompleteContainer']//div[@id='autoCompleteMultiple']" +
            "//div[contains(concat(' ', @class, ' '), ' auto-complete__menu-list ')]/div"));
        private IWebElement AutoCompleteSuggestionByText(string text) => WebDriver.FindElement(By.XPath("//div[@id='autoCompleteContainer']//div[@id='autoCompleteMultiple']" +
            $"//div[contains(concat(' ', @class, ' '), ' auto-complete__menu-list ')]/div[text()='{text}']"));
        private IWebElement AutoCompleteFiledValueByText(string text) => WebDriver.FindElement(By.XPath("//div[@id='autoCompleteContainer']//div[@id='autoCompleteMultiple']"+ 
            $"//div[contains(concat(' ', @class, ' '), ' auto-complete__multi-value ') and ./div[text()='{text}']]"));
        private IWebElement AutoCompleteFiledValueRemoveButtonByText(string text) => WebDriver.FindElement(By.XPath("//div[@id='autoCompleteContainer']//div[@id='autoCompleteMultiple']" +
        ...
        private IWebElement ButtonByName(string buttonName) => WebDriver.FindElement(By.XPath($"//div[@id='progressBarContainer']//button[text()='{buttonName}']"));
        private IWebElement ProgressBar => WebDriver.FindElement(By.XPath("//div[@id='progressBarContainer']//div[@id='progressBar']/div"));
